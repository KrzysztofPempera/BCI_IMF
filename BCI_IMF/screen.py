...
class screen():
    ...
    def run(self, start_program):
        ...
        while True:
            ...
            self.__modulate_stimuli_opacity__(stimuli1, self.frame, 10, 60, 0)
            self.__modulate_stimuli_opacity__(stimuli2, self.frame, 12, 60, 0.5)
            self.__modulate_stimuli_opacity__(stimuli3, self.frame, 14, 60, 1)
